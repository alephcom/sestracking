...
<div class="row">
    <div class="col-lg-10">
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <form method="post" action="{{ route('admin.projects.ses-suppression.store', $project) }}" class="row g-3 align-items-end">
                    @csrf
                    <div class="col-md-6">
        ...
        <div class="card mt-3">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                @if($nextToken)
                    <a class="btn btn-sm btn-outline-primary" href="{{ route('admin.projects.ses-suppression.index', ['project' => $project, 'next_token' => $nextToken]) }}">Next page</a>
                @endif
            </div>
                            ...
                            <tbody>
                                @foreach($summaries as $row)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <form method="post" action="{{ route('admin.projects.ses-suppression.destroy', $project) }}" class="d-inline" onsubmit="return confirm('Remove this address from the SES suppression list?');">
                                                @csrf
                                                @method('DELETE')
